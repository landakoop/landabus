$(document).ready(() => {
	...
	const ibilbideak = new Tabulator(".ibilbideak-zerrenda__taula", {
	    ajaxURL: ":8080/api/ibilbidea/list-gaur",
	    ajaxConfig:"GET",
	    layout: "fitColumns",
	    tooltips: true,
	    addRowPos: "top",
	    ...
	    rowClick:function(e, row){
	    	url = ":8080/api/geltokia/list2?ibilbideaID="+row.getData().ibilbideaID;
	...
	const geltokiak = new Tabulator(".ibilbideak-eskaerak__taula", {
	    ajaxURL: ":8080/api/geltokia/list2?ibilbideaID=1",
	    ajaxConfig:"GET",
	    layout: "fitColumns",
	    tooltips: true,
	    addRowPos: "top",
	...
	$("#ibilbideak-toolbar__gaur").click(function(){
		ibilbideak.replaceData(":8080/api/ibilbidea/list-gaur");
	...
	$("#ibilbideak-toolbar__bihar").click(function(){
		ibilbideak.replaceData(":8080/api/ibilbidea/list-bihar");
	...
	$("#ibilbideak-toolbar__denak").click(function(){
		ibilbideak.replaceData(":8080/api/ibilbidea/list");
